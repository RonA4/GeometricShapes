...
//            double x = rect.getCenPoint().x();
//            double y = rect.getCenPoint().y();
//            double width = rect.getWidth();
//            double height = rect.getHeight();
//            if (isFill) {
//                StdDraw_Ex2.filledRectangle(x, y, width / 2, height / 2);
//            } else {
//                StdDraw_Ex2.rectangle(x, y, width / 2, height / 2);
////           }
               ps = new Point_2D[]{r.getD(), r.getA(), r.getB(), r.getC()};
    ...
    public void actionPerformed(String p) {
        ...
        if (p.equals("ByTag")) {
            _shapes.sort(ShapeComp.CompSortByTag);
        }
        if (p.equals("ByAntiTag")) {
            _shapes.sort(ShapeComp.SortByAntiTag);
        }
        // ByAntiPerimeter
        if (p.equals("Clear")) {
            _shapes.removeAll();
